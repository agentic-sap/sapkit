...
Shared ALV display rules for generated ABAP programs.

## Display Mode Selection

**Full ALV** → `CL_GUI_ALV_GRID`
- Custom Screen (e.g. 0100) created via the MCP screen-creation tool (or SE51)
- GUI Status (standard BACK/EXIT/CANCEL + application toolbar) created via the MCP GUI-status tool (or SE41)
...
Reference: `templates/alv/field-catalog-guide.abap`.
