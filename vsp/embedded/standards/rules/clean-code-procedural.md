...
When generating a Procedural program's main `REPORT` source, the generated code MUST start from and conform to the canonical sample:

**Source of truth**: [`templates/procedural/main-program.abap`](templates/procedural/main-program.abap).
