...
func focusedToolSet() map[string]bool {
	return map[string]bool{
		...
		"ActivateGroup":      true,  // Whole-FUGR activation in one run
		...
		"ListStandards": true, // Catalog of embedded coding rules/templates/checklists
		"GetStandard":   true, // Fetch one standards document

		// Install/Setup tools
		"InstallZADTVSP":     true, // Deploy ZADT_VSP WebSocket handler to SAP
		"InstallALVHandlers": true, // Deploy reusable ALV/Tree OOP handler classes to SAP
