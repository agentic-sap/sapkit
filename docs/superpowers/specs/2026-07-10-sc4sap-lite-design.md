# sc4sap-lite — 3사 하네스 공통 라이트 버전 설계서

> **상태: 설계 확정 (2026-07-10). 구현 미착수. Fable 5 서브에이전트 + Codex CLI(0.144.1) 독립 이중 리뷰 반영.**
>
> **정본 이동 (2026-07-10 Phase L0)**: 이 문서의 정본은
> `D:\claude for SAP\sc4sap-lite\DESIGN.md`로 이동했다. 본 파일은 이동 시점의
> 스냅샷이며, 이후 갱신은 sc4sap-lite 쪽에서만 한다.
...
| **L2 서버 이관** | server/ 구성, connected 설치 검증 | tools/list 원본 일치 + 프로파일 미설정 시 write 도구 미노출 수용 테스트 통과 |
