...
| 등록점 (`지음` 판정) | `src/tools/registry.ts` | 있음 · 51종 등재 |
...
| 계약 시험 결과 | `evidence/contract/results.json` | 있음 · 51종 |
| 계약 시험 파일 | `src/tools/**/__tests__/<도구>.test.ts` | 있음 · 51종에 시험 파일이 있다 — 있음이 곧 통과는 아니다 |
