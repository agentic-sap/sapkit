...
도구 186 · **안 지음 32** · **증거 대기 132** · **증거 있음 22**
...
| 등록점 (`지음` 판정) | `src/tools/registry.ts` | 있음 · 154종 등재 |
...
| 계약 시험 결과 | `evidence/contract/results.json` | 있음 · 154종 |
| 계약 시험 파일 | `src/tools/**/__tests__/<도구>.test.ts` | 있음 · 154종에 시험 파일이 있다 — 있음이 곧 통과는 아니다 |
...
- **안 지음 32** — 등록점에 없다
- **증거 대기 132** — 지었으나 요구 증거 급이 아직 안 찼다
- **증거 있음 22** — 요구 급이 찼다

어느 급에서도 통과 증거가 없는 도구 **32종** (요구 급 충족과는 다른 질문이다 — 증거가 있어도 급이 덜 찰 수 있다).
