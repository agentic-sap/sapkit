...
도구 186 · **안 지음 0** · **증거 대기 136** · **증거 있음 50**
...
| 재생 판정 파일 | `evidence/replay/*.json` | 있음 · 3건 |
...
| GetSqlQuery | 시스템·공통 조회 | 1 | 재생 대조 + 대체 | — | 통과(1) | — | 통과(1) | 직접 |
...
| GetProgram | 프로그램 | 8 | 재생 대조 | 통과(1) | 통과(1) | 통과(1) | — | 간접 |
