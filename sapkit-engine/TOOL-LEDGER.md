...
도구 186 · **안 지음 166** · **증거 대기 18** · **증거 있음 2**
...
| 등록점 (`지음` 판정) | `src/tools/registry.ts` | 있음 · 20종 등재 |
...
| 계약 시험 결과 | `evidence/contract/results.json` | 있음 · 19종 |
| 계약 시험 파일 | `src/tools/**/__tests__/<도구>.test.ts` | 있음 · 20종에 시험 파일이 있다 — 있음이 곧 통과는 아니다 |
...
|---|---|---|---|---|---|---|---|---|
| DescribeByList | 시스템·공통 조회 | 1 | 재생 대조 | — | — | — | — | 간접 |
| GetAbapAST | 시스템·공통 조회 | 1 | 계약 시험 | — | — | — | — | 간접 |
| GetAbapSemanticAnalysis | 시스템·공통 조회 | 1 | 계약 시험 | — | — | — | — | 간접 |
| GetAbapSystemSymbols | 시스템·공통 조회 | 1 | 재생 대조 | — | — | — | — | 간접 |
| GetObjectInfo | 시스템·공통 조회 | 1 | 계약 시험 | — | — | — | — | 간접 |
| GetObjectStructure | 시스템·공통 조회 | 1 | 재생 대조 | — | — | — | — | 간접 |
| GetPackageTree | 시스템·공통 조회 | 1 | 계약 시험 | — | — | — | — | 직접 |
| GetSession | 시스템·공통 조회 | 1 | 재생 대조 | — | — | — | — | 간접 |
| GetSystemInfo | 시스템·공통 조회 | 1 | 재생 대조 | — | — | — | — | 직접 |
| GetTransaction | 시스템·공통 조회 | 1 | 재생 대조 | — | — | — | — | 간접 |
| GetTypeInfo | 시스템·공통 조회 | 1 | 재생 대조 | — | — | — | — | 간접 |
| GetWhereUsed | 시스템·공통 조회 | 1 | 재생 대조 | — | — | — | — | 간접 |
| GetObjectsByType | 검색 | 2 | 계약 시험 | — | — | — | — | 간접 |
| GrepPackages | 검색 | 2 | 재생 대조 | — | — | — | — | 직접 |
| ReloadProfile | 런타임 — 덤프·프로파일러·시스템 메시지 | 4 | 재생 대조 | — | — | — | — | 간접 |
| RuntimeAnalyzeDump | 런타임 — 덤프·프로파일러·시스템 메시지 | 4 | 계약 시험 | — | — | — | — | 직접 |
| RuntimeAnalyzeProfilerTrace | 런타임 — 덤프·프로파일러·시스템 메시지 | 4 | 재생 대조 | — | — | — | — | 직접 |
| RuntimeCreateProfilerTraceParameters | 런타임 — 덤프·프로파일러·시스템 메시지 | 4 | 계약 시험 | — | — | — | — | 직접 |
| RuntimeGetDumpById | 런타임 — 덤프·프로파일러·시스템 메시지 | 4 | 계약 시험 | — | — | — | — | 직접 |
| RuntimeGetGatewayErrorLog | 런타임 — 덤프·프로파일러·시스템 메시지 | 4 | 재생 대조 | — | — | — | — | 간접 |
| RuntimeGetProfilerTraceData | 런타임 — 덤프·프로파일러·시스템 메시지 | 4 | 재생 대조 | — | — | — | — | 직접 |
| RuntimeListDumps | 런타임 — 덤프·프로파일러·시스템 메시지 | 4 | 재생 대조 | — | — | — | — | 직접 |
| RuntimeListProfilerTraceFiles | 런타임 — 덤프·프로파일러·시스템 메시지 | 4 | 재생 대조 | — | — | — | — | 직접 |
| RuntimeRunClassWithProfiling | 런타임 — 덤프·프로파일러·시스템 메시지 | 4 | 재생 대조 | — | — | — | — | 직접 |
| RuntimeRunProgramWithProfiling | 런타임 — 덤프·프로파일러·시스템 메시지 | 4 | 재생 대조 | — | — | — | — | 직접 |
| GetIncludesList | 인클루드 | 5 | 재생 대조 + 대체 | — | — | — | 요구 · 미기록 | 간접 |
| CreateClass | 클래스 | 6 | attended 실기 | — | — | — | — | 직접 |
| GetClassMethod | 클래스 | 6 | 재생 대조 | — | — | — | — | 간접 |
| GetLocalDefinitions | 클래스 | 6 | 계약 시험 | — | — | — | — | 간접 |
| GetLocalMacros | 클래스 | 6 | 계약 시험 | — | — | — | — | 간접 |
| GetLocalTestClass | 클래스 | 6 | 재생 대조 | — | — | — | — | 직접 |
| GetLocalTypes | 클래스 | 6 | 재생 대조 | — | — | — | — | 간접 |
| ReadClass | 클래스 | 6 | 재생 대조 | — | — | — | — | 간접 |
| UpdateClassMethod | 클래스 | 6 | 재생 대조 | — | — | — | — | 간접 |
| UpdateLocalTestClass | 클래스 | 6 | 재생 대조 | — | — | — | — | 간접 |
| UpdateLocalTypes | 클래스 | 6 | 재생 대조 + 대체 | — | — | — | 요구 · 미기록 | 간접 |
| CreateTable | 테이블 | 7 | attended 실기 | — | — | — | — | 간접 |
| GetTableContents | 테이블 | 7 | 재생 대조 | — | — | — | — | 간접 |
| ReadTable | 테이블 | 7 | 재생 대조 | — | — | — | — | 간접 |
...
| CreateView | 뷰 | 11 | attended 실기 | — | — | — | — | 간접 |
| GetView | 뷰 | 11 | 재생 대조 | — | — | — | — | 간접 |
| ReadView | 뷰 | 11 | 재생 대조 | — | — | — | — | 간접 |
| UpdateView | 뷰 | 11 | 재생 대조 | — | — | — | — | 간접 |
...
| GetServiceDefinition | 서비스 정의 | 24 | 재생 대조 | — | — | — | — | 간접 |
...
| UpdateInterface | 인터페이스 | 27 | 계약 시험 | — | — | — | — | 직접 |
| GetEnhancementImpl | 인핸스먼트 | 28 | 계약 시험 | — | — | — | — | 간접 |
| GetEnhancements | 인핸스먼트 | 28 | 계약 시험 | — | — | — | — | 직접 |
| GetEnhancementSpot | 인핸스먼트 | 28 | 계약 시험 | — | — | — | — | 간접 |
...
| GetInstalledComponents | 시스템·공통 조회 | 1 | 재생 대조 | — | 시험 있음 · 결과 미기록 | — | — | 직접 |
...
- **안 지음 166** — 등록점에 없다
- **증거 대기 18** — 지었으나 요구 증거 급이 아직 안 찼다
- **증거 있음 2** — 요구 급이 찼다

어느 급에서도 통과 증거가 없는 도구 **167종** (요구 급 충족과는 다른 질문이다 — 증거가 있어도 급이 덜 찰 수 있다).
