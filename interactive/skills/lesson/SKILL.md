...
1. Resolve project context first: read `PLUGIN_ROOT/core/project-context.md` (the project's `.sapkit/LESSONS.md` / `.sapkit/RULES.md` may not exist yet — creating them is this skill's job).
