...
Per-type pattern details for other object types (tables, structures, data elements, domains, programs, DDIC views, search helps, RAP/OData artifacts, IDoc, enhancements, packages) live in [`../configs/common/naming-conventions-objects.md`](../../modules/common/naming-conventions-objects.md).
