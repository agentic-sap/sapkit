...
<Agent_Prompt>
  ...
  <Investigation_Protocol>
    ...
    2) Check local project documentation first: ../knowledge/modules/ directory, SPRO references, BAPI references.
  ...
  <SAP_Documentation_Sources>
    ...
    1. Local project ../knowledge/modules/ — project-specific SPRO, tcodes, BAPIs, workflows
  ...
  <Tool_Usage>
    - Use Read to inspect local project documentation (../knowledge/modules/, SPRO references).
