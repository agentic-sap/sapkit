...
> 작성 2026-07-10 · 최종 갱신 2026-08-18. 새 세션은 ① 이 문서 → ② 필요 시 해당 트랙
...
> | 인증 | Basic **접속** · `--env=<name>` **접속** · `--mcp=<destination>` **토큰 계층까지**(판5 — 코드는 있으나 **기동이 취득을 돌리지 않는다** · 실접속은 판6) · 브로커 **저장소 재료까지** | 4통로 전부 접속 |
>
...
>
> ## ✅ 직전 판 — **판6.1: M1 증거 완주 — 첫 attended SAP 판 (D-092 신설)** (2026-08-18)
>
