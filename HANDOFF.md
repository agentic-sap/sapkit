...
> **다음 착수 = 트랙 A 부트스트랩** (§5 서두 — 선결 5-9/5-10 완료, DESIGN.md §16부터).
...
|---|---|---|
| **트랙 A 부트스트랩 (DESIGN.md §16 — 다음 착수)** | ✅ (vsp 빌드 필요) | ✅ — 소스 2종 + vsp.exe 빌드본 실재 (§3) |
...
git log --oneline | head                                 # 최근: 726f5ebe(D-018/019·5-10 문서) ← 11f8d854(엔진 4.13.2)
```
