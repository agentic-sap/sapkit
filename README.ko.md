...
SAPKIT은 [superclaude-for-sap](https://github.com/babamba2/superclaude-for-sap)(백승현, babamba2)에서
시작했습니다. 지식·페르소나·절차의 기본 구조와 「사람이 승인하고 SAP이 검증한다」는 철학을
그 프로젝트에서 가져왔습니다. 지금은 대부분 다시 썼지만 그 구조는 그대로 유지하고 있습니다.

MCP 서버는 [abap-mcp-adt-powerup](https://github.com/hjaewon/abap-mcp-adt-powerup)(백승현이 만든
것을 포크한 것)과 그 원형인 [mcp-abap-adt](https://github.com/fr0ster/mcp-abap-adt)(fr0ster ·
mario-andreschak 원작)의 ADT-over-MCP 작업을 바탕으로 만들었습니다. 엔진은 새로 개발했습니다. 다만 어떤 도구가 필요하고 각 도구가 SAP과
무엇을 주고받아야 하는지는 이 두 프로젝트가 먼저 정해 두었습니다.

오프라인 ABAP 검사기는 [vibing-steampunk](https://github.com/oisee/vibing-steampunk)(Alice Vinogradova)와
그 원천인 [abaplint](https://github.com/abaplint/abaplint)(Lars Hvam Petersen)의 규칙과 판정 기준을
계승합니다.

superclaude-for-sap의 원저작자 고지는 [`interactive/LICENSE`](interactive/LICENSE)에 그대로 남아
있습니다. 각 프로젝트에서 어느 부분을 이어받고 어느 부분을 새로 썼는지는 라이선스와 함께
[THIRD_PARTY_NOTICES](interactive/THIRD_PARTY_NOTICES.md)에 정리되어 있습니다.
