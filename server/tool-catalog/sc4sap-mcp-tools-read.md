...
Get / Read / List / Search / Check handlers — schema, metadata, object introspection, navigation, and server-side syntax checks. Part of [sc4sap-mcp-tools.md](sc4sap-mcp-tools.md).
...
- mcp__plugin_sc4sap_sap__GetAtcFindings
...
## Check* / List* / Search* / Describe*

- mcp__plugin_sc4sap_sap__CheckSyntax
